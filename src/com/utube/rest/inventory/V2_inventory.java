...
import com.utube.dao.MySqlSchema;

/**
 * This class is used to manage computer parts inventory. It improves
 * V1_inventory.java
 * 
 * @author 308tube
 */
...
public class V2_inventory {
	...
	/**
	 * This method returns the specific brand of PC parts the user is looking for.  
	...
	public Response returnBrandParts(
		...
		try {
			...
			MySqlSchema dao = new MySqlSchema();
