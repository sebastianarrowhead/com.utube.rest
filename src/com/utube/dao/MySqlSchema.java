...
public class MySqlSchema extends MySqlDataSource {

	/**
	 * Method searches for a specific brand from the PC_PARTS table. By using
	 * prepareStatement and the ?, we protect against sql injection
	 * 
